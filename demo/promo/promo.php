...
// Pobierz produkty, które są objęte promocją
$product_stmt = $pdo->query("SELECT * FROM products WHERE new_price < price");
...
<main>
    ...
    <h2>Produkty objęte promocją</h2>
    
    <?php if (empty($products)): ?>
        <p>Brak produktów objętych promocją.</p>
    <?php else: ?>
